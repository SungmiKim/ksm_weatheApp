...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput returnKeyType="done" onSubmitEditing={addToDo} onChangeText={onChangeText} placeholder={working ? "Add a To Do" : "어디로 여행갈까?"} style={styles.input}></TextInput>

      <ScrollView>
        {Object.keys(toDos).map((key) =>
          toDos[key].working === working ? (
            <View style={styles.toDo} key={key}>
              <Text style={{ ...styles.toDoText, textDecorationLine: toDos[key].checked ? "line-through" : null, color: toDos[key].checked ? "green" : "white" }}>{toDos[key].text}</Text>
